...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2016 at 04:53 PM
...
CREATE TABLE IF NOT EXISTS `agentfees` (
  `feesid` int(16) NOT NULL AUTO_INCREMENT,
...
(2, 5, 1, 'Ahmed', 'Akter', 'agentaa', 'AG12345678', 'agentaa@aapf.tk', '1992-10-05', 'Part Time Job Holder, Short Time Student.', '2015-09-11 06:19:36', 1, 3, 0, 5, 'Whats so Hurry ???', 'null'),
(3, 5, 1, 'Mamun', 'Yen', 'yanmamun', 'XGC12345678', 'yen@aa.com', '1992-10-05', 'Part time Student', '2015-09-27 14:10:33', 2, 1, 0, 4, 'New', 'NULL');
...
CREATE TABLE IF NOT EXISTS `colleges` (
  `collegeid` int(16) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1992108 ;
...
(1, 'Ahmed', 'Akter', 'admin@aapf.tk', 'admin', '$2y$08$.roi64bLbZvkOIZodsCrUe8/WnL/y/8lcOvjOzFGZ.JT0XvOCFqfW', 'AA Planetica', '+8801676287208', '127.0.0.1', 'd996f1e967368ae0bb4a5dda4db8e6458f3c7083', 1, '', NULL, NULL, 'QRNrtuYOP5DClGfvYcq7XO', 1268889823, 1477971196),

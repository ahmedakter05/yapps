...
class Admin extends CI_Controller {
	...
	private function _init()
	{
		...
		//$this->load->js('assets/aries/js/plugins.js');
		//$this->load->js('assets/aries/js/charts.js');
		//$this->load->js('assets/aries/js/actions.js');
	...
	public function Index($page = 'index'){
		...
		else
		{
			...
			$this->load->view('aries_admin/users/'.$page, $this->data);
	...
	function change_password($page="change_password")
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			// render
			$this->_render_page('aries_admin/users/'.$page, $this->data);
		}
		else
		{
			...
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect('users/admin/change_password', 'refresh');
			}
		}
	}
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->_render_page('aries_admin/users/forgot_password', $this->data);
		}
		else
		{
			...
			if ($forgotten)
			{
				...
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				$this->session->set_userdata('last_page', current_url()); redirect('users/admin/login', 'refresh'); //we should display a confirmation page here instead of the login page
			}
			else
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->_render_page('aries_admin/users/reset_password', $this->data);
			}
			else
			{
				...
				else
				{
					...
					{
						$this->session->set_flashdata('message', $this->ion_auth->errors());
						redirect('users/admin/reset_password/' . $code, 'refresh');
					}
				}
			}
		}
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->_render_page('aries_admin/users/deactivate_user', $this->data);
		}
		else
		{
	...
	function create_group()
	{
		...
		if ($this->form_validation->run() == TRUE)
		{
			...
			if($new_group_id)
			{
				...
				// redirect them back to the admin page
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				$this->session->set_userdata('last_page', current_url()); redirect('users/admin', 'refresh');
			}
		}
		else
		{

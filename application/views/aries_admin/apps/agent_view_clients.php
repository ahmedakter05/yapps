                    ...
                    <div class="span10">
                        <div class="block">
                            <div class="span11">
                                ...
                                <span class="label label-success" style="color: #FFF; align: right;"> <?php echo anchor('apps/level/index', lang('level_view_link'))?></span>
                            </div>
                            <div class="span1">
                        ...
                        <div class="block">
                            ...
                            <div class="data-fluid">
                                <table cellpadding="0" cellspacing="0" width="100%" class="table">
                                    ...
                                    <tbody>
									<?php foreach ($agentclients as $client):?>
                                        <tr>
                                            <td>

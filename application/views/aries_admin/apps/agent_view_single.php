            ...
            <div class="block">
                ...
                <div class="data dark" style="">
                    <div class="data-fluid">
                        ...
                        <thead>
                            <tr>
                                <th width="13%" style="vertical-align: text-top;">
                                <?php echo lang('college_name_label');?>
                                </th>
                                <th width="12%" style="vertical-align: text-top;">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                <td style="text-align: center; font-weight: bold;"><?php echo anchor("apps/agent/view_college/".$fee->collegename, strtoupper($fee->collegename));?></td>
                                <td style="text-align: center;"><?php echo htmlspecialchars($fee->fees1 . ' Tk');?></td>
                                <td style="text-align: center;"><?php echo htmlspecialchars($fee->fees2 . ' Tk');?></td>
                                <td style="text-align: center;"><?php echo htmlspecialchars($fee->fees3 . ' Tk');?></td>
                                <td style="text-align: center;"><?php echo htmlspecialchars($fee->fees4 . ' Tk');?></td>
                                <td style="text-align: center;"><?php echo htmlspecialchars($fee->fees5 . ' Tk');?></td>
                                <td style="text-align: center;"><?php $totalfees = $fee->fees1 + $fee->fees2 + $fee->fees3 + $fee->fees4 + $fee->fees5;echo htmlspecialchars($totalfees . ' Tk');?></td>
                                <td style="text-align: center;"><?php echo anchor("apps/agent/fees_edit/".$fee->feesid, 'Change') ;?></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                        </table>
                        ...
                        <div class="span3">
                            <span class="label label-info" style="color: #FFF; align: center;"> <?php echo anchor("apps/agent/fees_add/".$agent['agentid'], lang('index_add_fee_link'))?></span>
                        </div>
                        <div class="span3"></div>
                        <div class="span3"></div>
                    </div>
            ...
            <div class="block">
                ...
                <div class="data dark" style="">
                    <div class="data-fluid">
                        ...
                        <div class="span3">
                            <span class="label label-success" style="color: #FFF; align: center;"> <?php echo anchor("apps/agent/agent_view_client/".$agent['agentid'], '<div style="color: #FFF;">View Clients of this Agent</div>') ;?></span>
                        </div>
                    </div>
                </div>         
            </div>
